...
<head>
    ...
    <title>Judge Modification</title>
    ...
    <div class="container">
        <div class="card">
            <% try {
                ...
                jb.connect();
                int aux = Integer.parseInt(request.getParameter("idJudge"));
                String lastname = request.getParameter("lastname");
                String firstname = request.getParameter("firstname");
                String court = request.getParameter("court");
                String[] values = {lastname, firstname, court};
                String[] fields = {"lastname", "firstname", "court"};
                jb.modificaTabela("judges", "idJudge", aux, fields, values);
                jb.disconnect(); %>
